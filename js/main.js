...
async function cairo() {
   var reqApi = await fetch('https://api.weatherapi.com/v1/forecast.json?key=72c1c3226ade4eecbb4135111221610&q=cairo&days=7');
...
// function to get the wind direction by name
var windDirection = "";
